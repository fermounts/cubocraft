...
def procesar_consulta_ia(texto_usuario: str, empresa: str, phone: str = "") -> str:
    ...
    system_text = (
        ...
        "Si la pregunta NO está relacionada con productos de seguridad industrial "
        "o sistemas constructivos, respondé únicamente: "
        "'No tengo información sobre eso, soy un asistente especializado en productos "
        "de seguridad industrial y sistemas constructivos.' "
        "Si la pregunta SÍ es del dominio pero el producto o norma no aparece en las "
        "RESPUESTAS VALIDADAS ni en las NORMATIVAS TÉCNICAS, aclaralo explícitamente "
        "antes de responder: 'Este producto/norma no está validado en nuestro catálogo "
        "todavía', y marcá la fuente como (fuente: no validado por CUBOCRAFT).\n\n"
